...
function DownloadIcon(props:{isActive:boolean}) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width="30"

      className={(props.isActive ? "active ":"") + "download-icon"}
      height="25"
      fill="none"
      viewBox="0 0 24 24"
    >
      ...
      <path
        fillRule="evenodd"
        d="M12 16.75a.75.75 0 00.553-.244l4-4.375a.75.75 0 10-1.107-1.012l-2.696 2.95V3a.75.75 0 00-1.5 0v11.068l-2.696-2.95a.75.75 0 00-1.108 1.013l4 4.375a.75.75 0 00.554.244z"
        clipRule="evenodd"
      ></path>
    </svg>
  );
